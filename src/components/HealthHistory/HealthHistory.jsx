            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    ...
                    <p className="text-slate-500 text-sm max-w-[200px] md:text-right">
                        Your chronological health assessments generated by AI.
                    </p>
                </div>

                {error ? (
                    <div className="bg-red-500/5 border border-red-500/20 p-6 rounded-2xl text-red-400 text-center font-medium">
                        {error}
                    </div>
                ) : reports.length === 0 ? (
                                ...
                                <div className="w-[calc(100%-4rem)] md:w-[45%] bg-slate-900/40 backdrop-blur-sm border border-white/5 p-8 rounded-[2rem] hover:border-cyan-500/30 transition-all duration-500">
                                    <div className="flex justify-between items-center mb-6">
                                        ...
                                        <span className="px-3 py-1 rounded-md bg-white/5 text-[10px] font-bold text-slate-400">
                                            ENTRY #{reports.length - index}
                                        </span>
                                    </div>

                                    <div className="space-y-6">
                                        <div>
                                            <h3 className="text-xs font-bold text-slate-500 uppercase tracking-tighter mb-2">Input Symptoms</h3>
